/**
 * Module initializes rest service UserDB_UserProfile_update_service
 */
...
define(['require'], function(require) {
    ...
    return [{
        type: 'service',
        name: 'UserDB_UserProfile_update_service',
        deps: ['Apperyio', 'REST', UserDB_UserProfile_update_serviceImpl]
    }];

    /**
     * @function UserDB_UserProfile_update_serviceImpl
     */

    function UserDB_UserProfile_update_serviceImpl(Apperyio, REST) {
...
/**
        ...
        this.config = {
            ...
            method: "put",
            headers: Apperyio.EntityAPI("UserDB_UserProfile_update_service.request.headers"),
            params: Apperyio.EntityAPI("UserDB_UserProfile_update_service.request.query"),
            data: Apperyio.EntityAPI("UserDB_UserProfile_update_service.request.body"),
            aio_config: {
                requestType: "json",
                responseType: "json",
                serviceName: "UserDB_UserProfile_update_service"
            }
        };
