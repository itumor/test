...
define(['require'], function(require) {
    ...
    return [{
        type: 'service',
        name: 'UserDB_UserProfile_list_service',
        deps: ['Apperyio', 'REST', UserDB_UserProfile_list_serviceImpl]
    }];

    /**
     * @function UserDB_UserProfile_list_serviceImpl
     */

    function UserDB_UserProfile_list_serviceImpl(Apperyio, REST) {
...
/**
        ...
        this.config = {
            ...
            method: "get",
            headers: Apperyio.EntityAPI("UserDB_UserProfile_list_service.request.headers"),
            params: Apperyio.EntityAPI("UserDB_UserProfile_list_service.request.query"),
            aio_config: {
                requestType: "",
                responseType: "json",
