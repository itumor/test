...
define(['require'], function(require) {
    ...
    return [{
        type: 'service',
        name: 'UserDB_UserProfile_create_service',
        deps: ['Apperyio', 'REST', UserDB_UserProfile_create_serviceImpl]
    }];

    /**
     * @function UserDB_UserProfile_create_serviceImpl
     */

    function UserDB_UserProfile_create_serviceImpl(Apperyio, REST) {
...
/**
        ...
        this.config = {
            ...
            method: "post",
            headers: Apperyio.EntityAPI("UserDB_UserProfile_create_service.request.headers"),
            params: Apperyio.EntityAPI("UserDB_UserProfile_create_service.request.query"),
            data: Apperyio.EntityAPI("UserDB_UserProfile_create_service.request.body"),
            aio_config: {
                requestType: "json",
                responseType: "json",
