angular.module("ui.rCalendar.tpls", ["calendar.html","day.html","displayEvent.html","month.html","monthviewDisplayEvent.html","monthviewEventDetail.html","week.html"]);
angular.module('ui.rCalendar', ['ui.rCalendar.tpls'])
    .constant('calendarConfig', {
        ...
        queryMode: 'local',
        step: 60,
        monthviewDisplayEventTemplateUrl: 'monthviewDisplayEvent.html',
        monthviewEventDetailTemplateUrl: 'monthviewEventDetail.html',
        weekviewAllDayEventTemplateUrl: 'displayEvent.html',
        weekviewNormalEventTemplateUrl: 'displayEvent.html',
        dayviewAllDayEventTemplateUrl: 'displayEvent.html',
        dayviewNormalEventTemplateUrl: 'displayEvent.html'
    })
...
angular.module("calendar.html", []).run(["$templateCache", function($templateCache) {
...
angular.module("day.html", []).run(["$templateCache", function($templateCache) {
...
angular.module("displayEvent.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("displayEvent.html",
    "<div class=\"calendar-event-inner\">{{displayEvent.event.title}}</div>");
}]);

angular.module("month.html", []).run(["$templateCache", function($templateCache) {
...
angular.module("monthviewDisplayEvent.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("monthviewDisplayEvent.html",
    "{{view.dates[row*7+col].label}}");
}]);

angular.module("monthviewEventDetail.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("monthviewEventDetail.html",
...
angular.module("week.html", []).run(["$templateCache", function($templateCache) {
