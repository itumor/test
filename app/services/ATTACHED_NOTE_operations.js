define(['require', 'lodash', 'AppClientInit'], function (require, _) {
	...
	return [{
		...
		type: 'service',
		name: 'ATTACHED_NOTE_get',
		deps: ['ATTACHED_NOTE', get]
	}, {
		type: 'service',
		name: 'ATTACHED_NOTE_find',
		deps: ['ATTACHED_NOTE', find]
	}, {
		type: 'service',
		name: 'ATTACHED_NOTE_count',
		deps: ['ATTACHED_NOTE', count]
	}, {
		type: 'service',
		name: 'ATTACHED_NOTE_create',
		deps: ['ATTACHED_NOTE', create]
	}, {
		type: 'service',
		name: 'ATTACHED_NOTE_update',
		deps: ['ATTACHED_NOTE', update]
	}, {
		type: 'service',
		name: 'ATTACHED_NOTE_delete',
		deps: ['ATTACHED_NOTE', remove]
	}];
});
