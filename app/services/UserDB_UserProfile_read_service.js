/**
 * Module initializes rest service UserDB_UserProfile_read_service
 */
...
define(['require'], function(require) {
    ...
    return [{
        type: 'service',
        name: 'UserDB_UserProfile_read_service',
        deps: ['Apperyio', 'REST', UserDB_UserProfile_read_serviceImpl]
    }];

    /**
     * @function UserDB_UserProfile_read_serviceImpl
     */

    function UserDB_UserProfile_read_serviceImpl(Apperyio, REST) {
...
/**
        ...
        this.config = {
            ...
            method: "get",
            headers: Apperyio.EntityAPI("UserDB_UserProfile_read_service.request.headers"),
            params: Apperyio.EntityAPI("UserDB_UserProfile_read_service.request.query"),
            aio_config: {
                requestType: "",
                responseType: "json",
                serviceName: "UserDB_UserProfile_read_service"
            }
        };
