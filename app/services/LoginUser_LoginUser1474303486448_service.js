/**
 * Module initializes rest service LoginUser_LoginUser1474303486448_service
 */
...
define(['require'], function(require) {
    ...
    return [{
        type: 'service',
        name: 'LoginUser_LoginUser1474303486448_service',
        deps: ['Apperyio', 'REST', LoginUser_LoginUser1474303486448_serviceImpl]
    }];

    /**
     * @function LoginUser_LoginUser1474303486448_serviceImpl
     */

    function LoginUser_LoginUser1474303486448_serviceImpl(Apperyio, REST) {
...
/**
        ...
        this.config = {
            url: "https://api.appery.io/rest/1/code/acf32776-d43a-406f-9198-e58dbaaa1778/exec",
            method: "get",
            headers: Apperyio.EntityAPI("LoginUser_LoginUser1474303486448_service.request.headers"),
            params: Apperyio.EntityAPI("LoginUser_LoginUser1474303486448_service.request.query"),
            aio_config: {
                requestType: "",
                responseType: "json",
                serviceName: "LoginUser_LoginUser1474303486448_service"
            }
        };
