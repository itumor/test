/**
 * Module initializes rest service appname_login_service
 */
...
define(['require'], function(require) {
    ...
    return [{
        type: 'service',
        name: 'appname_login_service',
        deps: ['Apperyio', 'REST', appname_login_serviceImpl]
    }];

    /**
     * @function appname_login_serviceImpl
     */

    function appname_login_serviceImpl(Apperyio, REST) {
...
/**
        ...
        this.config = {
            ...
            method: "get",
            headers: Apperyio.EntityAPI("appname_login_service.request.headers"),
            params: Apperyio.EntityAPI("appname_login_service.request.query"),
            aio_config: {
                requestType: "",
                responseType: "json",
                serviceName: "appname_login_service"
            }
        };
