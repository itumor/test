/**
 * Module initializes rest service NEWCRM_GET_OUSER_GET_LEAD_get
 */
...
define(['require'], function(require) {
    ...
    return [{
        type: 'service',
        name: 'NEWCRM_GET_OUSER_GET_LEAD_get',
        deps: ['Apperyio', 'REST', NEWCRM_GET_OUSER_GET_LEAD_getImpl]
    }];

    /**
     * @function NEWCRM_GET_OUSER_GET_LEAD_getImpl
     */

    function NEWCRM_GET_OUSER_GET_LEAD_getImpl(Apperyio, REST) {
...
/**
        ...
        this.config = {
            url: "https://api.appery.io/rest/1/apiexpress/api/GET_OUSER/GET_LEAD",
            method: "get",
            headers: Apperyio.EntityAPI("NEWCRM_GET_OUSER_GET_LEAD_get.request.headers"),
            params: Apperyio.EntityAPI("NEWCRM_GET_OUSER_GET_LEAD_get.request.query"),
            aio_config: {
                requestType: "",
                responseType: "json",
                serviceName: "NEWCRM_GET_OUSER_GET_LEAD_get"
            }
        };
