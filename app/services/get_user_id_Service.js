/**
 * Module initializes rest service get_user_id_Service
 */
...
define(['require'], function(require) {
    ...
    return [{
        type: 'service',
        name: 'get_user_id_Service',
        deps: ['Apperyio', 'REST', get_user_id_ServiceImpl]
    }];

    /**
     * @function get_user_id_ServiceImpl
     */

    function get_user_id_ServiceImpl(Apperyio, REST) {
...
/**
        ...
        this.config = {
            ...
            method: "get",
            headers: Apperyio.EntityAPI("get_user_id_Service.request.headers"),
            params: Apperyio.EntityAPI("get_user_id_Service.request.query"),
            aio_config: {
                requestType: "",
                responseType: "json",
                serviceName: "get_user_id_Service"
            }
        };
