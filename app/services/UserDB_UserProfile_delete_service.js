...
define(['require'], function(require) {
    ...
    return [{
        type: 'service',
        name: 'UserDB_UserProfile_delete_service',
        deps: ['Apperyio', 'REST', UserDB_UserProfile_delete_serviceImpl]
    }];

    /**
     * @function UserDB_UserProfile_delete_serviceImpl
     */

    function UserDB_UserProfile_delete_serviceImpl(Apperyio, REST) {
...
/**
        ...
        this.config = {
            ...
            method: "delete",
            headers: Apperyio.EntityAPI("UserDB_UserProfile_delete_service.request.headers"),
            params: Apperyio.EntityAPI("UserDB_UserProfile_delete_service.request.query"),
            aio_config: {
                requestType: "",
                responseType: "json",
