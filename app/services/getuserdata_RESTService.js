/**
 * Module initializes rest service getuserdata_RESTService
 */
...
define(['require'], function(require) {
    ...
    return [{
        type: 'service',
        name: 'getuserdata_RESTService',
        deps: ['Apperyio', 'REST', getuserdata_RESTServiceImpl]
    }];

    /**
     * @function getuserdata_RESTServiceImpl
     */

    function getuserdata_RESTServiceImpl(Apperyio, REST) {
...
/**
        ...
        this.config = {
            ...
            method: "get",
            headers: Apperyio.EntityAPI("getuserdata_RESTService.request.headers"),
            params: Apperyio.EntityAPI("getuserdata_RESTService.request.query"),
            aio_config: {
                requestType: "",
                responseType: "json",
                serviceName: "getuserdata_RESTService"
            }
        };
